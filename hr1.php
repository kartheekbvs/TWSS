...
#ab {
    ...
    padding: 0;
    height: 3vh;
    position: right; /* Ensure that the body is positioned relative to set bottom-right anchor */
    position: absolute;
    bottom: 20px; 
    right: 20px;
    padding: 10px 20px;
...
<a href="http://localhost/assist.php" id="ab">TWSS assistance</a>
</section>
<footer>
        <p>&copy; 2024 TWSS. All rights reserved.(DEVELOPED BY KARTHEEK AND BHANU)</p>
    </footer>
</body>
</html>