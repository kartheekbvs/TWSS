 ...
 .       }
    ...
    <div class="menu">
        ...
        <div class="dropdown">
            ...
            <hr>
            <a href="#">About</a>
            <a href="C:\Users\TRAINING\Desktop/contactus.html">Contact</a>
            <a class="item" href="C:\Users\TRAINING\Desktop\hr1.html">home</a>
        </div>
    </div>
    <h2>registsration Form</h2>
<div class="demo1">
...
$("#inputState").change(function(){
  ...
  <br> <br>
  <label for="select">choose ur course:</label>
  <select id="a" name="degree">
...
<br> <br>
 <label>learnig course:</label>
       <input type="text" name="course" placeholder="enter your course">
<br> <br>
         <label>ur adrress:</label>
       <input type="text" name="adrress" placeholder="enter your adrress">
<br> <br>
...
$name5 = htmlspecialchars($_POST['state']);
$name6 = htmlspecialchars($_POST['district']);
$name7 = htmlspecialchars($_POST['degree']);
$name8 = htmlspecialchars($_POST['college']);
$name9 = htmlspecialchars($_POST['course']);
$name10 = htmlspecialchars($_POST['adrress']);
  if (empty($name)) 
{
    echo "Name is empty";
  } else {
...
$sql = "INSERT INTO student (firstname,lastname,phno,email,state,district,course,college,learningcourse,adress	)
VALUES ('$name','$name2','$name3','$name4','$name5','$name6','$name7','$name8','$name9','$name10')";
...
INSERT INTO marks (name,c) values(' $candidate_name','$score')