...
<body>
 ...
 .       }
    ...
    <div class="menu">
        ...
        <span></span>
        <div class="dropdown">
            <a href="http://localhost/validate.php">Login</a>
            <hr>
...
$("#inputState").change(function(){
  ...
  <label for="options">college:</label>
    <textarea name="college" placeholder="enter your college"></textarea>
<br> <br>
 <label>learnig course:</label>
       <textarea name="course" placeholder="enter your course"></textarea>
<br> <br>
         <label>Ur Adrress:</label>
       <textarea name="adrress" placeholder="enter your adrress"></textarea>
<br> <br>
